...
import javax.swing.*;
public class ConfirmEventGui extends javax.swing.JFrame {

  private JTextField idField;
    
  public ConfirmEventGui() {
        super("");
 ...
 submitButton.addActionListener(new ActionListener() {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ConfirmEventGui.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ConfirmEventGui().setVisible(true);
            }
        });
    }
