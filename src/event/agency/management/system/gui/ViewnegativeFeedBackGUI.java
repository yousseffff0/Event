 ...
 */
public class ViewnegativeFeedBackGUI extends javax.swing.JFrame {
        private JTable negativeFeedBackTable;
    public ViewnegativeFeedBackGUI (ArrayList<feedback> feedback) {
      ...
      negativeFeedBackTable = new JTable(tableModel);
        JScrollPane scrollPane = new JScrollPane( negativeFeedBackTable);
